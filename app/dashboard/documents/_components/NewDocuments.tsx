...
import { createCustomer } from '@/lib/actions/customers.actions';
...
const NewDocuments = ({
  ...
  // Route redirect se pehly ye tha 17/10/2025
        setShowInvoice(true);
        //  router.push("/dashboard/documents/newdocuments");
    }
    ...
    const handleCancel = () => {
      ...
      // Route redirect se pehly ye tha 17/10/2025
    // ✅ If showInvoice is true → render InvoiceInterface directly
    if (showInvoice) {
    ...
    return (
        <>
            ...
            <div className="h-[calc(100dvh-52px)] overflow-y-auto scrollbar-custom  ">
                ...
                <Card className="h-full  ">
                    ...
                    <CardContent className=" ">
                        ...
                        <div className="flex border-t-2 pt-2 ">
                            <div
                                className={`mt-2 flex flex-col ELMB:w-[50%] pr-2 border-r-2`}
                            >
